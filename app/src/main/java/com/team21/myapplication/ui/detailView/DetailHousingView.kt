...
fun DetailHousingView(
    ...
    val isOfflineEmpty = !isOnline &&
            uiState.title.isBlank() &&
            uiState.amenityLabels.isEmpty() &&
            uiState.imagesFromServer.isNullOrEmpty()
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            if (isOfflineEmpty) {
                Column(
                    ...
                    // Header con back SOLAMENTE (no mostramos el corazón aquí)
                    Row(
                    ...
                    // Contenido centrado: imagen + mensaje
                    Box(
                        modifier = Modifier
                            .fillMaxSize(),
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.cloud_no_connection),
                                contentDescription = "Offline"
                            )
                            Spacer(Modifier.height(16.dp))
                            Text(
                                text = "You are offline, we will load when connection is back",
